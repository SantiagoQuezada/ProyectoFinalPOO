...
public class Planes extends JFrame {
	...
	public Planes(Empleado empleado) {
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				btnVolver.setBackground(new Color(0, 120, 110));
			}
		...
		btnCatalogo.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnCatalogo.setBackground(new Color(0, 80, 160));
			}
		...
		btnConsultas.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnConsultas.setBackground(new Color(80, 80, 80));
			}
		...
		RoundedPanel cardEmpresariales = crearTarjetaPlan("\uD83C\uDFE2", "EMPRESARIALES", "Soluciones Corporativas",
				"Empresarial");
	...
	private RoundedPanel crearTarjetaPlan(String icono, String titulo, String subtitulo, String categoriaReal) {
		...
		JLabel lblDesc = new JLabel(
				"<html><div style='text-align: center; width: 200px;'>" + subtitulo + "</div></html>");
		...
		boton.addActionListener(e -> mostrarMenuAsignacion("Asignar Plan: " + titulo, categoriaReal));
	...
	private void mostrarMenuAsignacion(String categoriaTitulo, String categoriaReal) {
		...
		headerPanel.setBackground(new Color(10, 10, 10));
		JLabel lblDialogTitle = new JLabel(categoriaTitulo);
	...
	private void mostrarMenuConsultas() {
		...
		cbEstado.setMaximumSize(new Dimension(160, 40));
		...
		cbTipo.setMaximumSize(new Dimension(160, 40));

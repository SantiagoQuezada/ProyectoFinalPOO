...
public class Planes extends JFrame {
    ...
    public Planes(Empleado empleado) {
        ...
        btnVolver.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) { btnVolver.setBackground(new Color(0, 120, 110)); }
            @Override
            public void mouseExited(MouseEvent e) { btnVolver.setBackground(new Color(0, 150, 136)); }
        });
    ...
    private void mostrarMenuConsultas() {
        ...
        btnCerrar.setBackground(new Color(220, 53, 69)); // Rojo
